...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
    ...
    @Query("select " +
            "new org.kraftenty.apiserver.dto.CartItemListDTO(ci.cino, ci.qty, p.pname, p.price, p.pno, pi.fileName) " +
            "from " +
    ...
    // 이메일과 상품 번호로 해당 상품이 장바구니 아이템으로 존재하는지 확인
    ...
    // 장바구니 아이템 번호로 장바구니 번호 를 얻어오려고 하는 경우
